...
-- Insert Users (50 from Manchester + 10 from original test, adjusted user_id)
...
VALUES
-- Manchester Users (user_id 1–50, unchanged)
...
-- Original Test Users (user_id 51–60, adjusted)
...
-- Insert Jobs (10 from Manchester + 5 from original test + 5 new completed/expired, adjusted job_id and created_by)
...
VALUES
-- Bids for Manchester Jobs (job_id 1–10)
...
-- Bids for Original Test Jobs (job_id 11–15, provider_id adjusted to 56–60)
...
-- Bids for completed and Expired Jobs (job_id 16–20)
...
-- Reset sequences to the next available ID
